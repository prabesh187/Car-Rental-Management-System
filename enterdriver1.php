...
$phone_error = validatePhoneWithMessage($driver_phone, 'Driver phone number');
if ($phone_error) {
    ?>
    <div class="container">
        <div class="jumbotron" style="text-align: center;">
            <h3 style="color: red;">Phone Number Error</h3>
            <?php echo $phone_error; ?>
            <br><br>
            <a href="enterdriver.php" class="btn btn-default"> Go Back </a>
        </div>
    </div>
    <?php
    exit();
...
// Clean phone number
$driver_phone = cleanPhone($driver_phone);
$driver_phone = $conn->real_escape_string($driver_phone);
