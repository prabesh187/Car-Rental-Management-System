    ...
    <div class="col-md-7" style="float: none; margin: 0 auto;">
      <div class="form-area">
        ...
        <br style="clear: both">
          ...
          <div class="form-group">
            <input type="tel" class="form-control" id="driver_phone" name="driver_phone" placeholder="Contact (10 digits)" required pattern="[0-9]{10}" maxlength="10" title="Please enter exactly 10 digits">
          </div>
...
<script>
// Phone number validation for 10 digits only
...
document.querySelector('form[action="enterdriver1.php"]').addEventListener('submit', function(e) {
